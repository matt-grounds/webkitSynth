		...
		init: function( options ) {
			...
			return this.each(function() {
				...
				if ($this.is('input:text')) {					
					...
					// HACK! gets knobRot working for me (submit as pull request?)
					realValueField.attr('autocomplete','off');
					...
					// HACK! moved animation update into an event response
					$this.on('globalKnobRotAnimationEvent', function() {
